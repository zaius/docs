...
[this guide](/docs/cli/requirements.html). It also assumes you have a free
[wercker account](https:/https://app.wercker.com/users/new/).

Lastly, if you don't have it already, you should [install the
CLI](/docs/using-the-cli/installing.html).
...
### Building your app
First, Let's review our `werkcer.yml` file. 
