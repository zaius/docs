...
- `env` - Space serperated  list of environment variables in the form of `"VAR=value" "VAR2=value2"` 
- `labels` - Adds a map of labels to a container. To specify a map, pass your space seperated labels into the `wercker.yml` file in this format `"LABEL=label" "LABEL2=label2"`
